...
import com.eastrobot.robotdev.job.MyJob;
...
public class QuartzTest  {
		...
		public static void startJob(String triggerName,String triggerGroupName) throws SchedulerException{
			  if(StringUtils.isBlank(triggerGroupName)){
				   triggerGroupName = TRIGGER_GROUP_NAME;
			   }
		       Scheduler sched = sf.getScheduler();
		       Trigger trigger = sched.getTrigger(triggerName,triggerGroupName);
		       JobDetail jobDetail = sched.getJobDetail(triggerName, triggerGroupName);
		       if(trigger != null){
