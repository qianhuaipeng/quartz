		...
		load: function(){
			...
			$('#menuDataGrid').datagrid({
		    	...
		    	columns:[[    
		    	          ...
		    	          {field:'yesRes',title:'yesRes',width:250,align:''} ,   
		    	          {field:'yesResType',title:'yesResType',width:250,align:''} ,
		    	          {field:'yesTagId',title:'yesTagId',width:250,align:''} ,
		    	          {field:'noRes',title:'noRes',width:200,align:''} ,
		    	          
		    	          {field:'noResType',title:'noResType',width:250,align:''} ,   
		    	          {field:'noTagId',title:'noTagId',width:250,align:''} ,
		...
		del : function(index){
			$.messager.confirm('Confirm', '确认删除?', function(r){
				if (r){
		    		...
		    		var id = row.id;
					$.ajax({
						url: 'yesNoDisambig/del.do?id='+id,
						type: 'get',
						dataType: 'json',
						success: function(data){
							if(data.success){
